...
| **API Contracts** | B+ | 9 undocumented | Update docs |
...
### Status: ⚠️ DOCUMENTATION OUT OF SYNC

#### Undocumented Endpoints (Add to `docs/reference/api-contracts.md`)

| # | Endpoint | Method | Purpose |
|---|----------|--------|---------|
| 1 | `/api/enrollments/[id]/start-class` | POST | Teacher starts class |
| 2 | `/api/enrollments/[id]/complete-class` | POST | Teacher completes class |
| 3 | `/api/enrollments/[id]` | DELETE | Terminate enrollment |
| 4 | `/api/admin/cancellations` | GET/POST | Pending cancellation approvals |
| 5 | `/api/admin/time-off-approvals` | POST | Approve time-off requests |
| 6 | `/api/admin/availability-approvals` | GET | Pending availability approvals |
| 7 | `/api/parent/cancel-class` | POST | Parent cancel class |
| 8 | `/api/admin/geocode-*` | POST | Geocoding tools |
| 9 | `/api/admin/stabilize-locations` | POST | Location stabilization |
| 10 | `/api/admin/validate-locations` | POST | Location validation |
| 11 | `/api/admin/import-students` | POST | Bulk student import |
| 12 | `/api/admin/re-encrypt-data` | POST | Data re-encryption |
| 13 | `/api/admin/travel-errors/*` | GET/PUT | Travel error management |
| 14 | `/api/admin/conflicts` | GET | Scheduling conflicts |
| 15 | `/api/admin/hot-times-stats` | GET | Scheduling analytics |

#### Missing Implementations (Documented but not built)

| # | Endpoint | Method | Status | Recommendation |
|---|----------|--------|--------|----------------|
| 1 | `/api/enrollments/[id]/completions/[cmpId]` | PUT | Not implemented | Add if needed, or remove from docs |
| 2 | `/api/students/[id]` | PUT | Not implemented | Uses query param instead |
| 3 | `/api/students/[id]/status` | PUT | Not implemented | Status changed via main update |
| 4 | `/api/students/search` | GET | Not implemented | Uses filters on main endpoint |
| 5 | `/api/teachers/[id]` | PUT | Not implemented | Uses query param instead |
| 6 | `/api/teachers/[id]/students` | GET | Not implemented | Add or remove from docs |
| 7 | `/api/notifications/[id]/read` | PUT | Uses POST | Update docs to POST |
| 8 | `/api/notifications/read-all` | PUT | Not implemented | Add or remove from docs |
| 9 | `/api/notifications/[id]` | DELETE | Not implemented | Add or remove from docs |
